 ...
 * http://www.zachstronaut.com/
 * Fork it on GitHub: https://github.com/zachstronaut/cispa-blackout
 */
...
function init() {
    ...
    document.getElementById('tsb-link-text').innerText=document.domain;
...
function rellotge(){
    ...
    document.getElementById("tsb-text").innerText=horaImprimible;
